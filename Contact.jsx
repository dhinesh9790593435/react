...
import { CiMenuBurger } from 'react-icons/ci'; // Import the menu icon// Import the play icon
import './App.css';
                  ...
                  <Container>
                          <Form>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                              <Form.Control id="inputs" type="text" placeholder="Your Name" />
                            </Form.Group>

                            <Form.Group className="mb-3" controlId="formBasicPassword">
                              <Form.Control id="inputs" type="password" placeholder="Password" />
                            </Form.Group>
                            
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                              <Form.Control id="inputs" type="text" placeholder="Subject" />
                            </Form.Group>
